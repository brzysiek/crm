...
STAGE_LABELS = {
    'new': 'Lead', 'in_progress': 'W trakcie', 'won': 'Wygrany',
    'lost': 'Przegrany', 'someday': 'Kiedyś',
}

STAGE_BADGE_CLASSES = {
    'new': 'badge-yellow', 'in_progress': 'badge-blue', 'won': 'badge-green',
    'lost': 'badge-red', 'someday': 'badge-gray',
}
