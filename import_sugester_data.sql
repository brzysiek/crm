...
-- oraz migration_crm_source_to_tags.sql.
...
-- Słownik źródeł
INSERT IGNORE INTO crm_tags (kind, name) VALUES ('source', 'Agnieszka Rożek'), ('source', 'Alicja Łapińska'), ('source', 'Aneta Januszko-Szakiel'), ('source', 'Ania Gustak'), ('source', 'Ania Pabian'), ('source', 'Ania Polak (kuek)'), ('source', 'Anka Badek'), ('source', 'Anna Watza'), ('source', 'BIAN'), ('source', 'BNI'), ('source', 'BNI Ania Watza'), ('source', 'BNI Szulc'), ('source', 'BNI Victoria'), ('source', 'BNI+'), ('source', 'Bartek Stodulski'), ('source', 'EMBA'), ('source', 'EMBA28'), ('source', 'Ela Poroś'), ('source', 'Kokurewicz'), ('source', 'LI Local Katowice'), ('source', 'MBA Polska'), ('source', 'Maja Drexler'), ('source', 'Monika Firlińska (EMBA29)'), ('source', 'Mytherapy'), ('source', 'Patrycja Hrabiec-Hojda'), ('source', 'Piotr Szczęch'), ('source', 'Rafał Włodarczyk'), ('source', 'Sebastian Łączny'), ('source', 'Wojciech Lelito'), ('source', 'członek BNI Milion'), ('source', 'gość BNI'), ('source', 'klient MH'), ('source', 'kuek'), ('source', 'Łukasz Żytniak');

-- Firma: Open Education Group Spółka Z Ograniczoną Odpowiedzialnością (Sugester ID 26986322)
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Open Education Group Spółka Z Ograniczoną Odpowiedzialnością', 'Open Education Group Spółka Z Ograniczoną Odpowiedzialnością', 'partner', 'Polska', 'Białystok', 'PODLASKIE', 'Ul. Jagienki 4', '15-480', 'e.poplawska@openeducation.pl', '+48664705711', '9661811272', 'http://openeducation.pl', NULL, NULL, NULL, '2026-05-21 14:08:19');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Bartek Stodulski');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Decyzja Komunikacyjna', 'Michał Krzak', 'lead', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Krowoderska 63B/6', '31-158', 'michal@krzak.pro', '+48667720320', NULL, 'http://krzak.pro', NULL, NULL, NULL, '2026-05-13 11:55:58');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('GOMEX BHP', 'GOMEX BHP', 'client', 'Polska', 'Dąbrowa Górnicza', 'ŚLĄSKIE', 'Emilii Zawidzkiej 10', '41-300', NULL, '+48507170444', '6292492638', 'https://gomex.com.pl/', NULL, NULL, (SELECT id FROM users WHERE full_name IN ('Lukasz Brzyski','Łukasz Brzyski') LIMIT 1), '2026-05-12 15:43:26');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('PPHU DREWNOTECH', 'PPHU DREWNOTECH', 'lead', 'Polska', 'Rzeszów', 'PODKARPACKIE', 'Mielecka 37', '35-504', 'b.flis01@gmail.com', '+48601095050', '8130139031', NULL, NULL, NULL, (SELECT id FROM users WHERE full_name IN ('Lukasz Brzyski','Łukasz Brzyski') LIMIT 1), '2026-05-05 13:08:41');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('M&A');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Wojciech Lelito');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Jarkom', 'Jarkom', 'lead', 'Polska', 'Radom', 'MAZOWIECKIE', 'Grabowska 22', '26-611', 'komasara.agata@gmail.com', '+48504720400', '7961011406', NULL, NULL, NULL, NULL, '2026-04-21 09:53:57');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Agnieszka Rożek');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kancelaria Dbs', 'Kancelaria Dbs', 'lead', 'Polska', 'Poznań', 'WIELKOPOLSKIE', 'Ul. Wojskowa 6/B2', '60-792', 'alicjarutkowska@kancelariadbs.pl', '513144548', '5213433604', 'http://www.kancelariadbs.pl', NULL, NULL, NULL, '2026-04-13 12:39:18');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBONy');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Techlabee.Ai', 'Techlabee.Ai', 'lead', 'Litwa', 'Vilnius', NULL, 'Vilniaus G. 33', '01402', 'bartosz@techlabee.ai', '+48608041825', 'LT100015147310', 'http://www.techlabee.ai', NULL, NULL, NULL, '2026-04-11 13:49:48');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Nowe Kompetencje', 'Nowe Kompetencje', 'lead', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Prosta 70', '00-838', 'kamila@nowekompetencje.ai', '+48600689609', '5214013697', 'http://www.nowekompetencje.ai', NULL, NULL, NULL, '2026-04-11 13:46:37');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Axpo Polska sp. z o.o.', 'Axpo Polska sp. z o.o.', 'lead', 'Polska', 'New York', NULL, NULL, '10017', 'malgorzata.cabak@partneraxpo.pl', '+48668321507', NULL, 'http://www.axpo.com', NULL, NULL, NULL, '2026-02-21 18:59:34');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Veryhome Real Estate', 'Veryhome Real Estate', 'lead', 'Polska', 'Kraków', NULL, NULL, '30-081', 'marta.lasak@veryhome.pl', '+48696464688', '6792754660', 'http://www.veryhome.pl', NULL, NULL, NULL, '2026-02-19 13:48:33');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('BNI Victoria');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Firma Produkcyjno Handlowo Usługowa Sigern Wojciech Fałowski Sp K', 'Adriana Fałowska', 'lead', 'Polska', 'Wielogłowy', 'MAŁOPOLSKIE', 'Wielopole 86', '33-311', 'adriana@sigern.pl', '+48608580403', '7343136277', 'http://www.sigern.pl', NULL, NULL, NULL, '2026-01-18 21:28:55');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Perspecto', 'Perspecto', 'partner', 'Polska', 'Katowice', NULL, NULL, '40-007', 'k.blazenek@perspecto.ba', '+48500160662', '6342934440', 'https://perspecto.ba', NULL, NULL, NULL, '2026-01-17 11:51:23');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Centrum Zarządzania Jakością "INFOX" Spółka z ograniczoną odpowiedzialnością', 'Centrum Zarządzania Jakością "INFOX" Spółka z ograniczoną odpowiedzialnością', 'lead', 'Polska', 'Bochnia', NULL, 'Brzeska 95', '32-700', 'ewa.mysliwy@czj-infox.pl', '+48506140460', NULL, 'https://czj-infox.pl', NULL, NULL, NULL, '2026-01-17 11:34:32');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('MDDP', 'MDDP', 'inne', 'Poland', 'Warszawa', 'MASOWIECKIE', 'Senatorska 18a', '02-677', 'michal.niton@mddp.pl', '+48503976057', '521-33-0-28-56', 'https://mddp.pl', NULL, NULL, NULL, '2026-01-14 14:59:23');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Toyota Dobrygowski', 'Toyota Dobrygowski', 'inne', 'Polska', 'Modlnica', 'MAŁOPOLSKIE', 'ul. Częstochowska 30', '32-085', 'a.kolodziej@toyotadobrygowski.pl', '+48881212086', '9441999719', 'https://toyotadobrygowski.pl', NULL, NULL, NULL, '2026-01-10 14:33:53');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Cztery Strony Zmian', 'CzteryStronyZmian', 'dostawca', 'PL', NULL, NULL, NULL, '31-826', 'ania@4sz.pl', '+48694593617', '6783182186', 'https://4sz.pl', NULL, NULL, NULL, '2026-01-10 14:31:58');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Baav Studio', 'BaavStudio', 'inne', 'Polska', 'Kraków', NULL, NULL, '31-153', 'ad@baavstudio.pl', '+48507725189', '6762512192', 'https://baavstudio.pl', NULL, NULL, NULL, '2026-01-10 14:31:51');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Ster24', 'sterBiuroRachunkoweSos24', 'client', 'polska', 'krakow', 'MALOPOLSKIE', 'ulJugowicka6B', '30-443', 'marcin.rej@ster24.com.pl', '+48512449070', '6751769655', 'https://ster24.com.pl', NULL, NULL, NULL, '2026-01-10 14:31:21');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Miśkowicz Pach I Partnerzy Kancelaria Radców Prawnych', 'MiśkowiczPach I Partnerzy KancelariaRadcówPrawnych', 'partner', 'Polska', 'Kraków', NULL, 'ArmiiKrajowej 19', '30-150', 'anna.pach@miskowicz-pach.pl', '+48668811379', '6762414775', 'https://miskowicz-pach.pl', NULL, NULL, NULL, '2026-01-10 14:23:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('SolMeb Ewelina Przybyś', 'Sol Meb', 'lead', 'Polska', 'Wieliczka', 'MAŁOPOLSKIE', 'ulTkosciuszki39', '32-020', 'biuro@meblemarzen.com', '+48517893510', '5662013149', 'https://meblemarzen.com', NULL, NULL, NULL, '2026-01-10 14:21:14');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Adwokatura', 'Adwokatura', 'lead', 'Polska', 'Warszawa', 'Mazowieckie', 'ul. Wiejska 15', '00-480', 'katarzyna.kawalec@adwokatura.pl', '606734059', '5252007890', 'https://adwokatura.pl', NULL, NULL, NULL, '2026-01-10 14:20:33');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('ZLSP', 'Zlsp', 'lead', 'Polska', 'Warszawa', NULL, NULL, '00-680', 'b.piaskowy@zlsp.org.pl', '+48501699763', '5260002164', 'https://zlsp.org.pl', NULL, NULL, NULL, '2026-01-10 14:20:31');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Online Group', 'Joanna Wojtyszyn', 'inne', 'Polska', 'Kraków', NULL, 'Bronowicka 23 lok. 10', NULL, 'joanna.wojtyszyn@onlinegroup.pl', '+48728631202', NULL, 'http://onlinegroup.pl', NULL, NULL, NULL, '2026-01-10 14:17:09');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('mieszkanie.com', 'mieszkanie.com', 'inne', 'Polska', 'Kraków', NULL, 'ul. Kazimierza Wielkiego 18', '30-074', 'ks@mieszkanie.com', '+48606836656', '6772467936', 'https://mieszkanie.com', NULL, NULL, NULL, '2026-01-10 14:14:08');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('Nieruchomości');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Mixtum', 'Mixtum', 'client', 'Polska', 'Rzezawa', 'MAŁOPOLSKIE', 'Przemysłowa 35', '32-765', 'stanislaw.skura@mixtum.pl', '+48691408482', '9252033878', 'https://mixtum.pl', NULL, NULL, NULL, '2026-01-10 13:38:13');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Plastcard', 'Plastcard', 'client', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Ul Balicka 100', '30-150', 'ajanuszkiewicz@plastcard.pl', '+48515125906', '5512117562', 'https://plastcard.pl', NULL, NULL, NULL, '2026-01-10 12:41:13');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('BIAN');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Biuro Informacji i Analiz Naukowych BIAN', 'Aneta Januszko-Szakiel', 'partner', 'Polska', NULL, NULL, NULL, NULL, 'aneta.szakiel@bian.pl', NULL, NULL, 'http://www.bian.pl', NULL, NULL, NULL, '2026-01-10 12:14:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('GigaCon', 'GigaCon', 'inne', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Bonifraterska6/8', '00-213', 'anna.karasinska@gigacon.org', '+48506981902', '7010350325', 'https://gigacon.org', NULL, NULL, NULL, '2026-01-09 20:40:42');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Złocień Ubezpieczenia', 'ZlocienUbezpieczenia', 'inne', 'Polska', 'Krakow', 'MALOPOLSKIE', 'UlZlocień22Lok2', '30-798', 'info@zlocienubezpieczenia.pl', '+48506979487', '6791436400', 'https://gigacon.org', NULL, NULL, NULL, '2026-01-09 20:38:16');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Witold Sadecki', 'Witold Sadecki', 'partner', 'Polska', 'Kraków', NULL, NULL, '31-826', 'witold@sadecki.org', '+48783942427', '6782740266', 'https://sadecki.org', NULL, NULL, NULL, '2026-01-09 20:31:27');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('FOGS', 'fogs', 'partner', 'Polska', NULL, NULL, NULL, NULL, 'p.baczewski@fogs.pl', '+48533055750', NULL, 'https://fogs.pl', NULL, NULL, NULL, '2026-01-09 18:29:49');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('AbiFlow sp. z o.o.', 'AbiFlow sp. z o.o.', 'inne', 'Polska', 'Rzeszów', 'PODKARPACKIE', 'Langiewicza 50', '35-021', 'mm@abiflow.com', '+48500248888', '6463004655', 'http://www.abiflow.com', NULL, NULL, NULL, '2026-01-09 18:27:54');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Inwentaryzacje Pro', 'inwentaryzacjeProSpZoo', 'inne', 'Polska', 'warszawa', 'MAZOWIECKIE', 'ulChroscickiego83Lok16', '02-414', 'wiktoria.staniewska@inwentaryzacjepro.pl', '+48662190997', '5252671274', 'http://www.inwentaryzacjepro.pl', NULL, NULL, NULL, '2026-01-09 18:27:30');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Proinnowacja', 'proinnowacja', 'partner', 'Polska', 'Kraków', 'Małopolskie', 'ul. Przykładowa 1', '30-001', 'biuro@proinnowacja.pl', '+48500123456', '6762345678', 'http://proinnowacja.pl', NULL, NULL, NULL, '2026-01-09 18:22:32');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Peak11', 'peak11', 'inne', 'Polska', 'Wrocław', NULL, NULL, '50-024', 'dominik.rogoz@peak11.com', '+48698060808', '8971839391', 'http://www.peak11.com', NULL, NULL, NULL, '2026-01-09 18:21:02');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('produkcja oprogramowania, software, CRM');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('CM Damiana', 'CM Damiana', 'partner', 'Polska', 'Warszawa', NULL, NULL, '02-739', 'radoslaw.rozek@damian.pl', '+48668344832', '5210336507', 'http://www.damian.pl', NULL, NULL, NULL, '2026-01-09 18:08:16');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('M&A');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Piotr Szczęch');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('AdAc Advanced Accounting', 'AdAcAdvancedAccounting', 'inne', 'Polska', 'Kraków', NULL, 'Walerego Sławka 5', '30-633', 'marek.szpala@adac.pl', '+48509137593', '6762234509', 'http://adac.pl', NULL, NULL, NULL, '2026-01-05 11:12:11');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('B-secure', 'B-secure', 'inne', 'Polska', NULL, NULL, NULL, NULL, 'dawid.mrowiec@bsecure.pl', '+48667051794', '6351743129', 'http://www.bsecure.pl', NULL, NULL, NULL, '2026-01-05 11:11:13');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Smartsist');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('ProFM Facility Management', 'profmFacilityManagement', 'lead', 'Polska', NULL, NULL, NULL, NULL, 'd.malysa@profm.com.pl', '+48504326028', NULL, 'http://profm.com.pl', NULL, NULL, NULL, '2026-01-05 11:10:05');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Wellness Travel', 'Wellness Travel', 'inne', 'Polska', 'Kraków', NULL, NULL, '31-153', 'kontakt@wellness.travel.pl', '+48698782032', '6762648796', 'http://www.wellness.travel.pl', NULL, NULL, NULL, '2025-12-31 15:46:48');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Konsultant Kanada', 'Konsultant Kanada', 'partner', 'PL', NULL, NULL, NULL, NULL, 'kristof.connect@gmail.com', '+48730186147', NULL, NULL, NULL, NULL, NULL, '2025-12-31 15:29:16');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('BNI Ania Watza');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Itgt', 'Itgt', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'ul. Pleszowska 13', '31-228', 'lukasz.walczyk@itgt.pl', '+48606303178', '945-150-14-18', 'http://www.itgt.pl', NULL, NULL, NULL, '2025-12-31 15:29:04');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Midero S. A.', 'Midero S. A.', 'dostawca', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Zabłocie 23/23', '30-701', 'a.swierczek@midero.io', '+48535588571', '6762499946', 'http://www.midero.io', NULL, NULL, NULL, '2025-12-31 15:28:46');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Patrycja Hrabiec-Hojda');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Cmw Sp. Zoo. Sp. K.', 'Cmw Sp. Zoo. Sp. K.', 'client', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Aleja Pokoju 57', '31-564', 'anna@cmw24.pl', '+48696686391', '6751671324', 'http://www.cmw24.pl', NULL, NULL, NULL, '2025-12-31 15:28:05');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI+');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Widacki, Widacka, Podsiedlik Kancelaria Prawna Spółka Komandytowo-Akcyjna', 'Widacki, Widacka, Podsiedlik Kancelaria Prawna Spółka Komandytowo-Akcyjna', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'ul. Karmelicka 47', '31-128', 'monika.widacka@wwpkancelaria.pl', '+48509650419', '676-247-23-44', 'http://www.wwpkancelaria.pl', NULL, NULL, NULL, '2025-12-31 15:27:48');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Celion Finanse', 'Celion Finanse', 'lead', 'Polska', 'Wrocław', 'DOLNOŚLĄSKIE', 'ul. Kawalerzystów 24/8', '53-004', 'a.rozanski@celion.pl', '+48504214170', '8133604084', 'https://www.celion.pl', NULL, NULL, NULL, '2025-12-31 15:27:20');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Academy Business Intelligence', 'Academy Business Intelligence', 'lead', 'Polska', 'Kraków', NULL, NULL, '31-873', 'elzbieta@jachymczak.pl', '+48793144371', '6792881270', 'http://www.jachymczak.pl', NULL, NULL, NULL, '2025-12-31 15:27:07');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Five Elements', 'Five Elements', 'lead', 'Polska', 'Warszawa', NULL, NULL, '02-676', 'barbara.giernat@aheadgroup.com.pl', '+48603632166', '5213645396', 'http://aheadgroup.com.pl', NULL, NULL, NULL, '2025-12-31 13:17:46');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Marifa (Joanna Chudoba)', 'Marifa (Joanna Chudoba)', 'partner', 'Polska', 'Katowice', NULL, NULL, '40-145', 'joanna@marifa.com.pl', '+48698003830', '9542385317', 'http://www.marifa.com.pl', NULL, NULL, NULL, '2025-12-31 13:09:13');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Złoty Kłos', 'Złoty Kłos', 'inne', 'Polska', 'Dobczyce', 'MAŁOPOLSKIE', 'ul. Jagiellońska 39A', '32-410', 'zlotyklos@interia.eu', '+48502831888', '6811003450', 'https://zlotyklos.com.pl', NULL, NULL, NULL, '2025-12-31 13:08:47');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Vaillant & Saunier Duval', 'Vaillant & Saunier Duval', 'inne', 'Polska', 'Kraków', NULL, NULL, '31-873', 'sekulowiczpawel@o2.pl', '+48503133849', '6791484501', 'http://www.vaillant-duval.pl', NULL, NULL, NULL, '2025-12-31 13:07:48');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Estimate', 'Estimate', 'lead', 'Polska', 'Gdańsk', NULL, NULL, '80-034', 'wojtek@i-estimate.pl', '+48606195589', '5832533956', 'http://www.i-estimate.pl', NULL, NULL, NULL, '2025-12-31 13:06:01');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Human Craft', 'Human Craft', 'inne', 'Polska', 'Kraków', NULL, NULL, '31-511', 'p.inna@human-craft.pl', '+48790884943', '6762584897', 'http://human-craft.pl', NULL, NULL, NULL, '2025-12-31 13:05:46');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('J Dauman Group', 'JDaumanGroup', 'inne', 'United Kingdom', 'London', NULL, 'CravenHouse,40-44UxbridgeRoad', 'W52BS', 'a.crich@jdauman.com', '+48505717215', '5252839352', 'http://jdauman.com', NULL, NULL, NULL, '2025-12-31 13:02:48');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('5DGroup', 'Engineering Construction Solutions', 'lead', 'Polska', 'Katowice', 'ŚLĄSKIE', 'ul. Mickiewicza29', '40-085', 'mateusz.marciniak@5dgroup.pl', '+48690566094', '787-210-52-74', 'http://www.5dgroup.pl', NULL, NULL, NULL, '2025-12-31 12:55:47');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('budowlanka');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('członek BNI Milion');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('KRK Novum', 'KRK Novum', 'inne', 'Polska', 'Kraków', NULL, NULL, '30-206', 'andrzej.krupinski@krknovum.pl', '+48601934002', '6793181829', 'https://exnatura.pl', NULL, NULL, NULL, '2025-12-31 12:53:46');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('LeadeRevolution', 'LeadeRevolution', 'partner', 'Polska', 'Warszawa', NULL, NULL, '02-798', 'ania@leaderevolution.pl', '+48512973303', '9512211905', 'https://leaderevolution.pl', NULL, NULL, NULL, '2025-12-31 12:51:45');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Desi9n Sp Z O. O.', 'Desi9n Sp Z O. O.', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Ul. Królewska 65a', '30-081', 'kontakt@desi9n.pl', '+48505097797', '6772377357', 'https://desi9n.pl', NULL, NULL, NULL, '2025-12-31 12:47:47');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Lewiatan');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kancelaria Patentowa LEDREMS®', 'Kancelaria Patentowa LEDREMS®', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'ul. Twardowskiego 57', '30-346', 'jolanta.wrobel@pirp.org.pl', '+48600852802', '6280009145', 'http://www.pirp.org.pl', NULL, NULL, NULL, '2025-12-31 12:46:49');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Lewiatan');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('SEMA-PRINT', 'SEMA-PRINT', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Wadowska 2', '31-990', 'jarek@semaprint.com.pl', '+48501496754', '6782676587', 'https://semaprint.com.pl', NULL, NULL, (SELECT id FROM users WHERE full_name IN ('Lukasz Brzyski','Łukasz Brzyski') LIMIT 1), '2025-12-27 21:23:46');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Maylane Polska', 'F. M. Dudhia', 'inne', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Rynek Główny 33', '31-010', 'CONTACT@MAYLANE.COM (fdudhia@maylane.pl)', NULL, '6762235176 (6762235176)', 'http://www.maylane.pl/', NULL, NULL, (SELECT id FROM users WHERE full_name IN ('Lukasz Brzyski','Łukasz Brzyski') LIMIT 1), '2025-12-27 20:36:28');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('KSB');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('nieruchomości');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('EMBA');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Nexia Global', 'NexiaGlobal', 'inne', 'Polska', 'Opole', 'OPOLSKIE', 'Technologiczna 2', '45-839', 'm.stelmach@nexia.global', '+48607057157', '7543363294', 'http://www.nexia.global', NULL, NULL, NULL, '2025-12-25 16:03:51');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('MBA Polska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Reklamini.pl', 'Reklamini.pl', 'inne', 'Polska', 'Gdańsk', NULL, NULL, '80-407', 'andrzej@reklamini.pl', NULL, '5842491108', 'https://reklamini.pl', NULL, NULL, NULL, '2025-12-24 12:24:45');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('marketing, reklama');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Explore Markets', 'ExploreMarkets', 'inne', 'Poland', 'Warsaw', 'MAZOWIECKIE', 'ul. Flory 7/30', '00-586', 'fredrik.udd@exploremarkets.pl', '+48602417917', '7011046162', 'http://exploremarkets.eu', NULL, NULL, NULL, '2025-12-24 12:24:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Next Level Academy by ModraSova', 'Next Level Academy by ModraSova', 'lead', 'Polska', 'Inowrocław', NULL, NULL, '88-100', 'info@nextlevelacademy.pl', '+48504463920', '5562791834', 'https://nextlevelacademy.pl', NULL, NULL, NULL, '2025-12-24 12:24:18');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Atneo Doradztwo Cło Podatki Prawo Sp. z o.o.', 'Atneo Doradztwo Cło Podatki Prawo Sp. z o.o.', 'lead', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'ul. Śniadeckich 17', '00-654', 'rafal.pogorzelski@atneo.pl', '+48664154217', '7010827182', 'http://www.atneo.pl', NULL, NULL, NULL, '2025-12-24 12:23:46');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Waterwalk Partners', 'Waterwalk® Partners', 'inne', 'Poland', 'Warsaw', NULL, 'ul. Śniadeckich 17', '00-654', 'mariusz.kowalski@waterwalk.partners', '+48661929486', '5252818967', 'http://waterwalk.partners', NULL, NULL, NULL, '2025-12-24 12:23:35');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Eden Millenia', 'EdenMilleniaSpZoO', 'lead', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Retoryka 1', '33-332', 'm.krupa@eden-millenia.com', '+48570710546', '5262594611', 'http://eden-millenia.com', NULL, NULL, NULL, '2025-12-24 12:23:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('nieruchomości');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kls S.J.', 'Kls S.J.', 'lead', 'Polska', 'Bytom', 'ŚLĄSKIE', 'ul. Musialika 53', '41-902', 'k.bochenek@kls.pl', '+48578600440', '626-26-93-007', 'http://www.kls.pl', NULL, NULL, NULL, '2025-12-24 12:16:03');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Smartsist');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('m Finanse', 'm Finanse', 'lead', 'Poland', 'Warszawa', 'MAZOWIECKIE', 'ul. Skorupki 5', '00-546', 'edyta.fiet@mfinanse.pl', '+48606563626', '7251903631', 'https://mfinanse.pl', NULL, NULL, NULL, '2025-12-24 12:15:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('finanse');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Indywidualny Kadr', 'Indywidualny Kadr', 'lead', 'Polska', NULL, NULL, NULL, NULL, 'indywidualnykadr@gmail.com', '+48732492964', NULL, NULL, NULL, NULL, NULL, '2025-12-24 12:15:17');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Be Partners', 'Be Partners', 'lead', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Wołoska 9', '02-583', 'pawel.nurzynski@bepartners.pl', '+48502558309', '6762446700', 'http://www.bepartners.pl', NULL, NULL, NULL, '2025-12-24 12:15:06');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Baront', 'Baront', 'lead', 'Polska', 'Sękowa', NULL, NULL, '38-307', 'a.sieklucki@icloud.com', '+48501777746', '7380004052', 'http://www.baront.pl', NULL, NULL, NULL, '2025-12-24 12:14:54');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Corporate Connections', 'CorporateConnections™', 'lead', 'Poland', 'Warsaw', 'MAZOWIECKIE', 'Chłodna 51', '00-867', 'l.olenski@cc.pl', '+48602239460', '5252796191', 'http://www.cc.pl', NULL, NULL, NULL, '2025-12-24 12:14:42');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Free Wolf', 'Free Wolf', 'lead', 'Polska', 'Sosnowiec', NULL, NULL, '41-200', 'maciej.dybczynski@freewolf.pl', '+48504014390', '6443577742', 'https://freewolf.pl', NULL, NULL, NULL, '2025-12-24 12:14:28');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('turystyka, podróże dla firm');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Raytheon An Rtx Business', 'RaytheonAnRtxBusiness', 'lead', 'Poland', 'Warsaw', 'MAZOWIECKIE', 'Mokotowska 49 (5th Floor)', '00-542', 'Kamil.J.Ziarnowski@rtx.com', '+48880733998', '5262799341', 'https://www.rtx.com', NULL, NULL, NULL, '2025-12-24 12:14:17');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Dobre Strony', 'Dobre Strony', 'lead', 'Polska', 'Kraków', NULL, NULL, '30-740', 'karolina@dobrestrony.it', '+48502989093', '6811904257', 'http://www.dobrestrony.it', NULL, NULL, NULL, '2025-12-24 12:13:42');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Adams Group', 'AdamsGroup', 'lead', 'Poland', 'Kobyla Góra', NULL, 'Ligota 59b', '63-507', 'lukasz.kucinski@adamsgroup.pl', '+48795072534', '5140284879', 'http://www.adamsgroup.pl', NULL, NULL, NULL, '2025-12-24 12:02:12');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('meble');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Womar Sp. Z O.o.', 'WOMAR Sp. z o.o.', 'lead', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'ul. Przykopy 5', '30-612', 'jszkaradek@womar.com', '+48601442418', '5130238837', 'http://www.womar.com', NULL, NULL, NULL, '2025-12-24 11:56:00');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('PKO Bank Polski', 'PKO Bank Polski', 'lead', 'Polska', 'Poznań', 'WIELKOPOLSKIE', 'ul. Roosevelta 22', '60-829', 'joanna.kucharska2@pkobp.pl', '+48600481206', '5250007738', 'http://www.pkobp.pl', NULL, NULL, NULL, '2025-12-24 11:54:01');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Itek Green Technologies', 'ItekGreenTechnologies', 'lead', 'Polska', 'Gdynia', 'POMORSKIE', 'Chwarznieńska 170A/5', '81602', 'szymon@itek.green', '+48604599739', '9571072753', 'http://itek.green', NULL, NULL, NULL, '2025-12-24 11:52:00');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Aldi Sp. z o.o.', 'Aldi Sp. Z O.o.', 'lead', 'Polska', 'Sopot', 'POMORSKIE', 'ul. Generała Władysława Sikorskiego 8/10', '81-827', 'przemyslaw.bednarski@aldi.pl', '+48881971207', '6292248566', 'http://www.aldi.pl', NULL, NULL, NULL, '2025-12-24 11:51:01');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Krajowy Instytut Prawa Gospodarczego Sp z o.o.', 'Krajowy Instytut Prawa Gospodarczego Sp z o.o.', 'lead', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Grzybowska 87', '00-844', 'pawel.juskowiak@kipg.pl', '+48602210006', '5272757671', 'http://www.kipg.pl', NULL, NULL, NULL, '2025-12-24 11:50:01');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Elżbieta Dönmez', 'Elżbieta Dönmez', 'lead', 'Polska', NULL, NULL, NULL, NULL, 'elzbieta.donmez@gmail.com', '+48508127555', NULL, NULL, NULL, NULL, NULL, '2025-12-24 10:13:35');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Strefa life', 'Strefa life', 'partner', 'PL', 'Kraków', NULL, NULL, '31-025', 'sierka.anna@gmail.com', '+48609632747', '6762243763', 'https://strefalife.com/', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('psychoterapia');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('BNI Szulc');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Księgowość (Led-pol)', 'Księgowość (Led-pol)', 'partner', 'PL', NULL, NULL, NULL, NULL, 'malgorzata.biuromm@wp.pl', '+48607594338', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Wojciech Lelito');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('LUX MED Sp. z o.o.', 'Luxmed', 'client', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Szturmowa 2', '02-676', 'Radoslaw.Fratczak@luxmed.pl', '+48695090319', '5272528741', 'http://www.luxmed.pl', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('M&A');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Mytherapy');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('proflow.pl', 'proflow.pl', 'dostawca', 'PL', 'Chrzanów', 'Województwo małopolskie', NULL, '40-085', NULL, '+48505476464', '6342825447', 'https://proflow.pl', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Software Mansion', 'Software Mansion', 'lead', 'PL', 'Kraków', NULL, NULL, '30-701', 'julianna.lekarczyk@swmansion.com', '+48530243548', '6762464105', 'http://www.swmansion.com', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('software house, oprogramowanie');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Kokurewicz');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Anna Kruk', 'Anna Kruk', 'partner', 'PL', 'Kraków', NULL, NULL, NULL, 'anetpol@gmail.com', '+48508896205', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Aberit', 'Aberit', 'partner', 'PL', 'Rzeszów', NULL, NULL, '54-204', 'm.misiuda@aberit.eu', '+48500248888', '8971735161', 'http://www.aberit.eu', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Inspire Sourcing', 'Inspire Sourcing', 'partner', 'PL', 'Kraków', NULL, NULL, '31-202', 'sylwia.leniartek@isourcing.pl', '+48124292021', '9452144869', 'http://www.isourcing.pl', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('LTV Project', 'LTV Project', 'lead', 'PL', 'Oświęcim', NULL, NULL, '44-100', 'jmoldoch@ltvprojekt.pl', '+48664474367', '6312662991', 'http://www.ltvproject.co.uk', NULL, NULL, NULL, '2025-12-24 09:47:34');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('WESTA GROUP', 'WESTA GROUP', 'client', 'PL', 'Wola Rzędzińska', NULL, NULL, '33-150', 'grzegorz.syrek@westagroup.pl', '+48606176209', '8733251761', 'https://www.westagroup.pl/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Ania Gustak');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Proenergy', 'Proenergy', 'lead', 'PL', 'Kraków', NULL, NULL, '30-698', 'karolmiskiewicz@proenergy.com.pl', '+48500331722', '6793102379', 'http://www.proenergy.com.pl', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Aneta Januszko-Szakiel');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Uni-Box', 'Uni-Box', 'lead', 'PL', 'Kobylany', NULL, NULL, NULL, 'urszula.kielar@uni-box.pl', '+48501777705', '1251624647', 'https://uni-box.pl/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Alicja Łapińska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('BeCool', 'BeCool', 'client', 'PL', 'Kraków', 'MAŁOPOLSKIE', 'Stojałowskiego 35/30', '30-611', 'biuro@becool.com.pl', '+48607312718', '6793260376', 'https://becool.com.pl/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Stan Trans', 'Stan Trans', 'lead', 'PL', 'Kraków', NULL, NULL, '31-752', 's.grabiec@stantrans.com.pl', '+48451059885', '6783115340', 'http://www.stantrans.com.pl', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kedarix', 'Kedarix', 'lead', 'PL', 'Zabierzów Bocheński', NULL, NULL, '32-007', 'aszewczyk@kedarix.com', '+48696030900', '6831861751', 'https://kedarix.com/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('CMW Ochrona', 'CMW Ochrona', 'client', 'PL', 'Kraków', NULL, NULL, '31-623', 'anna@altes.pl', '+48696686391', '6782806259', 'https://altes.pl/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Hat-Trick', 'Hat-Trick', 'lead', 'PL', 'Zator', NULL, NULL, '32-640', 'janusz@hattrick.net.pl', '+48606460806', '5492193568', 'https://hattrick.net.pl/', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('S2Innovation', 'S2Innovation', 'client', 'PL', 'Kraków', NULL, NULL, '30-348', 'piotr.goryl@s2innovation.com', '+48795794004', '6762562470', 'https://s2innovation.com', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Łukasz Żytniak');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Raben Group', 'Raben Group', 'lead', 'PL', 'Robakowo', NULL, NULL, '62-023', 'katarzyna.ostojska@raben-group.com', '+48693800072', '7770005553', 'https://raben-group.com', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Ania Pabian');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Systemcold Solutions', 'Systemcold Solutions', 'client', 'PL', 'Szczepanowice (Słomniki)', NULL, NULL, '30-698', 'j.clapa@systemcold.pl', '+48575991121', '6793108603', 'https://systemcold.pl', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('HR BeeHive', 'HR BeeHive', 'partner', 'PL', 'Warszawa', NULL, NULL, '00-105', 'contact@hrbeehive.com', '+48784408548', '5213904669', 'http://www.hrbeehive.pl', NULL, NULL, NULL, '2025-12-24 09:47:33');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('EMBA');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('HR');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('EMBA28');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Katarzyna Kiszkiel | Analityk Biznesowy', 'Katarzyna Kiszkiel | Analityk Biznesowy', 'partner', 'PL', 'Komorów', NULL, NULL, '05-806', 'katarzyna.kiszkiel@analitykbiznesowy.com', '+48501961504', '1181652434', 'http://www.analitykbiznesowy.com', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('KAMIL ZOŃ ROYAL SERVICE (Kamil Zoń)', 'KAMIL ZOŃ ROYAL SERVICE (Kamil Zoń)', 'lead', 'PL', 'Kraków', NULL, NULL, NULL, 'kamilzon@vp.pl', '+48669430090', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Magda Jarczak', 'Magda Jarczak', 'partner', 'PL', 'Kraków', NULL, NULL, '30-384', 'magdalena.jarczak@digilkd.pl', '+48690644494', '6792687989', 'https://digilkd.pl', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('HR');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('ATJ GROUP', 'ATJ GROUP', 'client', 'PL', 'Zabierzów', NULL, NULL, '32-080', 'biuro@atjgroup.pl', '+48509705110', '5130235332', 'https://atjgroup.pl', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Kontakt Rafała');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Grupa Taka', 'Grupa Taka', 'partner', 'PL', 'Gliwice', NULL, NULL, '44-100', 'mateusz.kopacz@grupataka.pl', '+48730060644', '6312662991', 'http://www.grupataka.pl', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Katarzyna Rapacz ESG', 'Katarzyna Rapacz ESG', 'client', 'PL', NULL, NULL, NULL, NULL, 'franczyk.katarzyna@gmail.com', '+48888730925', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Wojciech Buda', 'Wojciech Buda', 'partner', 'PL', NULL, NULL, NULL, NULL, 'wojciech.budakontakt@gmail.com', '+48502427406', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('ASK Atelier Aleksandra Skrzypek-Kwiecien', 'ASK Atelier Aleksandra Skrzypek-Kwiecien', 'client', 'PL', 'Kraków', NULL, NULL, NULL, 'aleksandra.skrzypek.landscape@gmail.com', '+48533685503', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Sebastian Łączny');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('KS Dynamika', 'KS Dynamika', 'client', 'PL', 'Krzeszowice', NULL, NULL, NULL, 'dorota.gorska@gmail.com', '+48', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Planet Partners', 'Ania Watza', 'partner', 'PL', NULL, NULL, NULL, NULL, 'a.watza@planetpartners.pl', '+48516086086', NULL, 'http://planetpartners.pl', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Hotel City & Spa', 'Hotel City & Spa', 'partner', 'PL', 'Kraków', NULL, NULL, '30-426', 'mmis@hotelcity.pl', '+48797648637', '6792683050', 'https://hotelcity.pl', NULL, NULL, NULL, '2025-12-24 09:47:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('HR Idea Anna Badek', 'HR Idea Anna Badek', 'partner', 'PL', 'Wieliczka', NULL, NULL, '32-020', 'anna.badek@hridea.pl', '+48720889669', '9442188414', 'http://hridea.pl', NULL, NULL, NULL, '2025-12-24 09:47:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('AI4App', 'AI4App', 'lead', 'Polska', 'Brzeg', NULL, NULL, 'Polska', 't.sokol@ai4app.pl', '+48661115910', '7471930156', 'https://ai4app.pl', NULL, NULL, NULL, '2025-12-24 09:43:26');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Smart-HR', 'Smart-HR', 'lead', 'Polska', 'Katowice', 'ŚLĄSKIE', 'ul. Dąbrówki 16', 'Polska', 'apycia@smart-hr.pl', '+48608609397', '9542761899', 'http://www.smart-hr.pl', NULL, NULL, NULL, '2025-12-24 09:43:26');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('HR');
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Anka Badek');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kancelaria Zysk', 'Kancelaria Zysk', 'lead', 'Polska', 'Kraków', NULL, NULL, 'Polska', 'klc@biurorachunkowezysk.pl', '+48609405091', '9452031124', 'https://biurorachunkowezysk.pl/', NULL, NULL, NULL, '2025-12-24 09:43:26');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Ecopak Daniel Czernecki', 'ecopak Daniel Czernecki', 'lead', 'Polska', 'Podegrodzie', NULL, NULL, 'Polska', 'ecopak.ns@gmail.com', '+48604572570', '7343611116', 'https://ecopak-ns.pl/', NULL, NULL, NULL, '2025-12-24 09:43:26');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('ESTEGH Sp. z o.o.', 'ESTEGH Sp. z o.o.', 'lead', 'Polska', 'Skawina', NULL, NULL, 'Polska', 't.slizowski@wynajemlasera.pl', '+48533313575', '9512491178', 'https://wynajemlasera.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('HR NAVIGATOR BEATA SIADEK', 'HR NAVIGATOR BEATA SIADEK', 'lead', 'Polska', 'Siepraw', NULL, NULL, 'Polska', 'kontakt@hrnavigator.com.pl', '+48502190639', '9452175330', 'https://hrnavigator.com.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('HarmonyHi', 'HarmonyHi', 'lead', 'Polska', 'Kraków', NULL, NULL, 'Polska', 'julia@harmonyhi.com', '+48692003208', '6792781428', 'http://www.harmonyhi.com', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Phormy', 'Phormy', 'lead', 'Polska', 'Bochnia', 'Województwo małopolskie', NULL, 'Polska', 'phormy@phormy.com', '+48662189142', '9451914946', 'https://phormy.com/', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Daria Frank', 'Daria Frank', 'lead', 'Polska', 'Bielsko-Biała', NULL, NULL, 'Polska', 'biuro@dariafrank.pl', '+48664302678', NULL, NULL, NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Inner Home', 'Inner Home', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'mariola@innerhome.pl', '+48660265117', '6792759556', 'https://innerhome.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kamila Kabzińska', 'Kamila Kabzińska', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'kabzinska.kamila@gmail.com', '+48664008914', NULL, NULL, 'https://www.linkedin.com/in/kamila-kabzi%C5%84ska/', NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('APP SystemsAI', 'APP SystemsAI', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'piotr.gawronski@interia.pl', '+48577821187', '5213934538', 'http://app-systemai.com', 'https://www.linkedin.com/in/piotr-gawro%C5%84ski-45922331b/', NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Gość BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Piwne Eventy Firmowe', 'Piwne Eventy Firmowe', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'tomek@jakzarobicpiwo.pl', '+48662031145', '8133544453', 'https://jakzarobicpiwo.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Beata Morsztyn', 'Beata Morsztyn', 'inne', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'bm@beatamorsztyn.pl', '+48501381600', '6772134446', 'https://beatamorsztyn.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('I Tak Zdasz', 'I Tak Zdasz', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', NULL, '+48727933310', '6772242371', 'https://itakzdasz.pl', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kancelaria Magnet', 'Kancelaria Magnet', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'monika.wolczynska@magnetaudit.eu', '+48663366494', '5272945890', 'https://magnetaudit.eu', NULL, NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Maja Drexler');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('TNK Consulting', 'TNK Consulting', 'lead', 'Polska', 'Warszawa', 'Województwo mazowieckie', NULL, 'Polska', NULL, '+48608583433', '8971866763', 'https://tnkc.pl/', 'https://www.linkedin.com/company/tnkc/', NULL, NULL, '2025-12-24 09:43:25');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('MyTherapy', 'MyTherapy', 'lead', 'Polska', 'Kraków', 'Województwo małopolskie', NULL, 'Polska', 'rafal.wlodarczyk@mytherapy.com.pl', '+48791296012', '6793216171', 'https://mytherapy.com.pl', NULL, NULL, NULL, '2025-12-24 09:43:24');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('M&A');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Ela Poroś');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('BLDG', 'Mariusz Bajor', 'lead', 'Polska', 'Kraków', 'MAŁOPOLSKIE', 'Zabłocie 43A', '30-701', 'mariusz.bajor@bldg.pl', '+48509242646', NULL, 'https://bldg.pl', NULL, NULL, NULL, '2025-12-24 09:38:24');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Bayer', 'Christopher Pawlak', 'lead', 'PL', 'Warszawa', NULL, NULL, '02-326', 'ch.pawlak10@gmail.com', '+41794346506', '5260019068', 'https://www.bayer.com/', 'https://www.linkedin.com/in/christopherpawlak/', NULL, NULL, '2025-12-24 09:38:24');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('kuek');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Partner Papes', 'Sebastian Bigos', 'lead', 'PL', 'Wrocław', 'Województwo dolnośląskie', NULL, '91-341', 's.bigos@partnerpapes.pl', '+48600305288', '7282513460', 'https://partnerpapes.pl/', 'https://www.linkedin.com/in/sebastianbigos/', NULL, NULL, '2025-12-24 09:38:24');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('poszukiwania nabywcy myTherapy', 'M&A');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Vision East Advisory', 'Jakub Kowalski', 'lead', 'PL', 'Warszawa', 'Województwo mazowieckie', NULL, NULL, NULL, '+48507024418', '5252818160', 'https://www.visioneastadvisory.com/', 'https://www.linkedin.com/company/vision-east-advisory/', NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('poszukiwania nabywcy myTherapy', 'M&A');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Ania Polak (kuek)');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('WLC', 'Wojciech Lelito', 'lead', 'PL', 'Kraków', 'Województwo małopolskie', NULL, '02-676', 'wojciech.lelito@wlc.com.pl', '+48601961378', '5213484988', 'https://wlc.com.pl', NULL, NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko BNI');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Anna Watza');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Monika Firlińska (EMBA29)');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Urpgor Systems', 'Paweł Darasz-Mól', 'lead', 'PL', 'Wrocław', 'Województwo dolnośląskie', NULL, '54-427', 'contact@urpgorsystems.com', '+48730133748', '8943164926', 'https://urpgorsystems.com/', 'https://www.linkedin.com/company/urpgor-systems/about/', NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('MBA Polska');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Optimum Materace', 'Anna Warchoł', 'lead', 'PL', 'Zarzecze', 'Województwo podkarpackie', NULL, '37-100', 'anna@optimum-materace.pl', '+48604259966', '8133863484', 'https://optimum-materace.pl/', NULL, NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('BNI+');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Confessor Capital', 'Dawid Lisowski', 'lead', 'PL', 'Jasionka', NULL, NULL, '36-002', 'dawid.lisowski@confessor-capital.com', '+48531667424', '5170402447', 'https://confessor-capital.com/', 'https://www.linkedin.com/company/confessorcapitalgroup/', NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('LI Local Katowice');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Fiklon', 'Hubert Turaj', 'lead', 'PL', 'Kraków', NULL, NULL, '30-552', 'hubert.turaj@fiklon.pl', '+48728350897', '6793292415', 'http://fiklon.pl/', NULL, NULL, NULL, '2025-12-24 09:38:23');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Reko');
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('Rafał Włodarczyk');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Kraków Nowa Huta Przyszłości S.A.', 'KrakówNowaHutaPrzyszłościS.A.', 'lead', 'PL', '[object Object]', 'MAŁOPOLSKIE', '[object Object]', '31-902', 'jacek.bielawski@knhp.com.pl', '+48696456680', '6783153839', 'http://www.knhp.com.pl', NULL, NULL, NULL, '2025-12-23 22:50:50');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Aspergo', 'Aspergo', 'lead', 'Polska', 'Łódź', 'ŁÓDZKIE', 'ul. Ks. Piotra Skargi 8/10', '90-059', 'gszwejser@aspergo.pl', '+48607078116', '7251957636', 'https://aspergo.pl', NULL, NULL, NULL, '2025-12-23 22:45:48');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='industry' AND name IN ('Ubezpieczenia');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Infinity Blue', 'Infinity Blue', 'inne', 'PL', 'Manchester', NULL, NULL, 'M40 5BJ', 'pawel@infinitybluegroup.com', '+48602489094', NULL, 'https://infinitybluegroup.com', 'https://www.linkedin.com/in/pawelbilczynski/', NULL, NULL, '2025-12-23 22:41:05');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Diagnostyka Consilio', 'Robert Głuszak', 'lead', 'PL', 'Warszawa', 'Województwo mazowieckie', NULL, 'Polska', 'adrobny@interia.pl', '+48506159733', '6751265009', 'https://diag.pl/', 'https://www.linkedin.com/in/andrzej-drobny-292229a7/', NULL, NULL, '2025-12-23 22:21:32');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='source' AND name IN ('klient MH');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Amber Glass, Karel hurtownie', 'Marcin Karel', 'lead', 'PL', 'Rybnik', NULL, NULL, '44-203', NULL, NULL, '6420013894', 'https://karel2.pl/', 'https://www.linkedin.com/in/marcin-karel-411bb894/', NULL, NULL, '2025-12-23 22:21:32');
SET @cid := LAST_INSERT_ID();
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Lafrentz', 'Mateusz Durski', 'inne', 'PL', 'Poznań', NULL, NULL, '60-179', NULL, NULL, '7791998348', 'https://lafrentz.pl/', 'https://www.linkedin.com/in/mateusz-durski-299106153/', NULL, NULL, '2025-12-23 22:21:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Accounting & Corporate Services', 'Ewa Ogłozińska', 'partner', 'PL', 'Warszawa', 'MAZOWIECKIE', 'Aleje Ujazdowskie 41', '00-540', 'eoglozinska@acs-group.pl', '+48729859891', '7010831278', 'https://acs-group.pl', 'https://www.linkedin.com/in/ewa-og%C5%82ozi%C5%84ska-933b96117/', NULL, NULL, '2025-12-23 22:21:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025', 'M&A');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Enterprise Ireland', 'Bartosz Siepracki', 'partner', 'PL', 'Dublin 3', NULL, NULL, 'D03 E5R6', 'bartosz.siepracki@enterprise-ireland.com', '+48608024264', 'IE9590828H', 'http://www.enterprise-ireland.com', 'https://www.linkedin.com/in/barteksiepracki/', NULL, NULL, '2025-12-23 22:21:32');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025', 'M&A');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Sopra Steria Polska Sp. z o.o.', 'Dorota Butryn', 'inne', 'Polska', 'Katowice', 'ŚLĄSKIE', 'Uniwersytecka 13', '40-007', 'dorota.butryn@soprasteria.com', '+48698097108', '5262886585', 'http://www.soprasteria.com', 'https://www.linkedin.com/in/dorota-butryn-79188174/', NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Tomczykowski Tomczykowska', 'Damian Libertowski', 'partner', 'PL', 'Warszawa', NULL, NULL, '00-339', 'd.libertowski@tomczykowscy.pl', '+48512761270', '5252516427', 'http://www.tomczykowscy.pl', 'https://www.linkedin.com/in/damian-libertowski-283992197/', NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025', 'M&A');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Anzena', 'Beata Kurek', 'inne', 'Polska', 'Katowice', 'ŚLĄSKIE', 'ul. Pszczyńska 15', '40-478', 'kurek.b@anzena.pl', '+48538506809', '9542740925', 'http://www.anzena.pl', 'https://www.linkedin.com/in/beata-kurek-a41493200/', NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Taxsafe', 'Svitlana Genna', 'partner', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'Ul. Floriańska 6 Lok. U2', '03-707', 'svitlana.genina@taxsafe.pl', '+48573664879', '5252823430', 'http://www.taxsafe.pl', NULL, NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('Colliers', 'Tadeusz Kowalczyk', 'partner', 'Polska', 'Warszawa', 'MAZOWIECKIE', 'ul. Pańska 97', '00-834', 'tadeusz.kowalczyk@colliers.com', '+48539538359', '5262263063', 'https://www.colliers.com', 'https://www.linkedin.com/in/tadeusz-kowalczyk-524195166/', NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025', 'M&A');
...
INSERT INTO crm_companies (name, short_name, relation_type, country, city, voivodeship, street, postal_code, email, phone, nip, website, linkedin_url, description, owner_user_id, created_at) VALUES ('GFS Engineering', 'Monika Wójcik', 'inne', 'PL', 'Katowice', NULL, NULL, '40-085', 'monika.wojcik@gfs-eng.com', '+48453072702', '6342838323', 'https://www.gfs-eng.com', NULL, NULL, NULL, '2025-12-23 22:21:31');
SET @cid := LAST_INSERT_ID();
INSERT INTO crm_company_tags (company_id, tag_id) SELECT @cid, id FROM crm_tags WHERE kind='tag' AND name IN ('Business Mixer Katowice 12/2025');
